...
def build_booking_graph(
    ...
    builder.add_node("phase_1", build_phase_1_node(agent_loop, extract_showtimes))
    ...
    # showtime flows to Phase 3 (get-to-seats), a rejection to the inform exit. Phase 3
    # doesn't exist yet, so ROUTE_GET_TO_SEATS maps to END as a placeholder.
    builder.add_conditional_edges(
        ROUTE_PRESENT_SHOWTIMES,
        route_after_phase_2,
        {
            ROUTE_GET_TO_SEATS: END,
